...
import aleksandr.fedotkin.core.core.exception.SetExternalException
import aleksandr.fedotkin.core.core.exception.SetInternalException
...
abstract class BaseSetUseCase<T : Model, R : DTO>(
    ...
    abstract suspend fun sendError(json: String): String
